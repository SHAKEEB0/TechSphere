...
- `POSTGRES_USER` = `techsphere_user`
- `POSTGRES_PASSWORD` = (value from Render Postgres service)
- `POSTGRES_HOST` = (hostname from Render Postgres service)
- `POSTGRES_PORT` = `5432`
